(function () {
  ...
  Object.assign(i18n, {
    ...
    ocHeroDesc: {
      ...
      ko: '이미지와 PDF를 텍스트로 변환하세요. 1페이지는 무료 온디바이스 OCR로, 최대 30페이지는 GPT-4o 기반 Smart OCR로 — 레이아웃·표·번역·요약·검색 가능한 PDF까지.',
      de: 'Verwandeln Sie Bilder und PDFs in Text. Kostenloses On-Device-OCR für eine Seite oder Smart OCR mit GPT-4o für bis zu 30 Seiten — Layout, Tabellen, Übersetzung, Zusammenfassung und durchsuchbares PDF.',
      es: 'Convierte imágenes y PDF en texto. OCR gratis en el dispositivo para una página, o Smart OCR con GPT-4o para hasta 30 páginas: diseño, tablas, traducción, resumen y PDF con búsqueda.',
      fr: 'Transformez images et PDF en texte. OCR gratuit sur l\'appareil pour une page, ou Smart OCR avec GPT-4o jusqu\'à 30 pages — mise en page, tableaux, traduction, résumé et PDF consultable.',
    },
    ...
    ocSmartTitle: { en: 'Smart OCR — GPT-4o', ko: 'Smart OCR — GPT-4o', de: 'Smart OCR — GPT-4o', es: 'Smart OCR — GPT-4o', fr: 'Smart OCR — GPT-4o' },
    ocSmartDesc: {
    ...
    ocSmartQLabel: { en: 'Smart OCR (GPT-4o)', ko: 'Smart OCR (GPT-4o)', de: 'Smart OCR (GPT-4o)', es: 'Smart OCR (GPT-4o)', fr: 'Smart OCR (GPT-4o)' },
    ocSmartQText: {
    ...
    ocFaqA1: {
      en: 'Free OCR runs on your device for one page and works best on clean printed text, with no layout or tables. Smart OCR uses GPT-4o for much higher accuracy, keeps layout as Markdown, extracts tables, reads handwriting and many languages, and handles up to 30 pages.',
      ko: '무료 OCR은 기기에서 한 페이지를 처리하며 레이아웃이나 표 없이 깨끗한 인쇄 텍스트에 가장 적합합니다. Smart OCR은 GPT-4o를 사용해 훨씬 높은 정확도로 레이아웃을 Markdown으로 유지하고 표를 추출하며, 손글씨와 다국어를 읽고 최대 30페이지를 처리합니다.',
      de: 'Kostenloses OCR verarbeitet eine Seite auf Ihrem Gerät und eignet sich am besten für klaren gedruckten Text ohne Layout oder Tabellen. Smart OCR nutzt GPT-4o für viel höhere Genauigkeit, behält das Layout als Markdown, extrahiert Tabellen, liest Handschrift und viele Sprachen und verarbeitet bis zu 30 Seiten.',
      es: 'El OCR gratuito procesa una página en tu dispositivo y funciona mejor con texto impreso limpio, sin diseño ni tablas. Smart OCR usa GPT-4o para una precisión mucho mayor, mantiene el diseño como Markdown, extrae tablas, lee escritura a mano y muchos idiomas, y admite hasta 30 páginas.',
      fr: 'L\'OCR gratuit traite une page sur votre appareil et fonctionne mieux sur un texte imprimé net, sans mise en page ni tableaux. Smart OCR utilise GPT-4o pour une précision bien supérieure, conserve la mise en page en Markdown, extrait les tableaux, lit l\'écriture manuscrite et de nombreuses langues, et gère jusqu\'à 30 pages.',
    },
    ...
    ocFaqA3: {
      en: 'Smart OCR (GPT-4o) handles Korean, mixed languages, and handwriting well. The free on-device option is weaker on those — use Smart OCR for best results.',
      ko: 'Smart OCR(GPT-4o)는 한국어, 혼합 언어, 손글씨를 잘 처리합니다. 무료 온디바이스 옵션은 이런 경우에 약하므로 최상의 결과를 위해 Smart OCR을 사용하세요.',
      de: 'Smart OCR (GPT-4o) verarbeitet Koreanisch, gemischte Sprachen und Handschrift gut. Die kostenlose On-Device-Option ist dabei schwächer — nutzen Sie für beste Ergebnisse Smart OCR.',
      es: 'Smart OCR (GPT-4o) maneja bien el coreano, los idiomas mixtos y la escritura a mano. La opción gratuita en el dispositivo es más débil en eso; usa Smart OCR para mejores resultados.',
      fr: 'Smart OCR (GPT-4o) gère bien le coréen, les langues mixtes et l\'écriture manuscrite. L\'option gratuite sur l\'appareil est moins performante — utilisez Smart OCR pour de meilleurs résultats.',
    },
