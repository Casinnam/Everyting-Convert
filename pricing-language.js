...
(function () {
  const translations = {
    ko: {
      ...
      'Background Remover — 15 credits': '배경 제거 — 15 크레딧',
    ...
    de: {
      ...
      'Background Remover — 15 credits': 'Hintergrund entfernen — 15 Credits',
    ...
    es: {
      ...
      'Background Remover — 15 credits': 'Eliminar fondo — 15 créditos',
    ...
    fr: {
      ...
      'Background Remover — 15 credits': 'Suppression d\'arrière-plan — 15 crédits',
