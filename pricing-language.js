...
(function () {
  const translations = {
    ko: {
      ...
      'AI Pay-as-you-go': 'AI 단건 결제',
      '+ /result': '+ /결과물',
      'No subscription needed': '구독 불필요',
      'See AI tool pricing': 'AI 도구 가격 보기',
      'Background Remover — $1.99': '배경 제거 — $1.99',
      'AI Transcription — $2.99': 'AI 텍스트 변환 — $2.99',
      'ID / Passport Photo — $2.99': '증명사진 / 여권사진 — $2.99',
      'Free preview before every payment': '모든 결제 전 무료 미리보기',
    ...
    de: {
      ...
      'AI Pay-as-you-go': 'KI Pay-as-you-go',
      '+ /result': '+ /Ergebnis',
      'No subscription needed': 'Kein Abo nötig',
      'See AI tool pricing': 'KI-Tool-Preise ansehen',
      'Background Remover — $1.99': 'Hintergrund entfernen — $1,99',
      'AI Transcription — $2.99': 'KI-Transkription — $2,99',
      'ID / Passport Photo — $2.99': 'Pass-/ID-Foto — $2,99',
      'Free preview before every payment': 'Kostenlose Vorschau vor jeder Zahlung',
      ...
      'ID / Passport Photo': 'Pass-/ID-Foto',
    ...
    es: {
      ...
      'AI Pay-as-you-go': 'IA de pago por uso',
      '+ /result': '+ /resultado',
      'No subscription needed': 'Sin suscripción',
      'See AI tool pricing': 'Ver precios de IA',
      'Background Remover — $1.99': 'Eliminar fondo — $1.99',
      'AI Transcription — $2.99': 'Transcripción IA — $2.99',
      'ID / Passport Photo — $2.99': 'Foto de identidad / pasaporte — $2.99',
      'Free preview before every payment': 'Vista previa gratis antes de cada pago',
      ...
      'ID / Passport Photo': 'Foto de identidad / pasaporte',
    ...
    fr: {
      ...
      'AI Pay-as-you-go': 'IA à la demande',
      '+ /result': '+ /résultat',
      'No subscription needed': 'Sans abonnement',
      'See AI tool pricing': 'Voir les prix des outils IA',
      'Background Remover — $1.99': 'Suppression d\'arrière-plan — 1,99 $',
      'AI Transcription — $2.99': 'Transcription IA — 2,99 $',
      'ID / Passport Photo — $2.99': 'Photo d\'identité / passeport — 2,99 $',
      'Free preview before every payment': 'Aperçu gratuit avant chaque paiement',
      ...
      'ID / Passport Photo': 'Photo d\'identité / passeport',
