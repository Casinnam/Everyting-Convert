(function () {
  ...
  const t = {
    ...
    whyFastT: { en: 'Fast Conversion', ko: '빠른 변환', de: 'Schnelle Konvertierung', es: 'Conversión rápida', fr: 'Conversion rapide' },
    whyFastB: { en: 'Convert files in seconds with a clean workflow.', ko: '깔끔한 작업 흐름으로 몇 초 만에 파일을 변환하세요.', de: 'Konvertiere Dateien in Sekunden mit einem klaren Ablauf.', es: 'Convierte archivos en segundos con un flujo sencillo.', fr: 'Convertissez vos fichiers en quelques secondes, simplement.' },
    whyPrivacyT: { en: 'Privacy First', ko: '프라이버시 우선', de: 'Datenschutz zuerst', es: 'Privacidad primero', fr: 'La confidentialité d’abord' },
    whyPrivacyB: { en: 'Your files are processed securely and never shared.', ko: '파일은 안전하게 처리되며 절대 공유되지 않습니다.', de: 'Ihre Dateien werden sicher verarbeitet und nie geteilt.', es: 'Tus archivos se procesan de forma segura y nunca se comparten.', fr: 'Vos fichiers sont traités en toute sécurité et jamais partagés.' },
    whyNoInstallT: { en: 'No Software Install', ko: '설치 불필요', de: 'Keine Software-Installation', es: 'Sin instalar software', fr: 'Aucune installation' },
    whyNoInstallB: { en: '100% web-based. Nothing to download or install.', ko: '100% 웹 기반. 다운로드나 설치가 필요 없습니다.', de: '100 % webbasiert. Nichts herunterzuladen oder zu installieren.', es: '100 % en la web. Nada que descargar ni instalar.', fr: '100 % en ligne. Rien à télécharger ni à installer.' },
    whyEverywhereT: { en: 'Works Everywhere', ko: '어디서나 작동', de: 'Funktioniert überall', es: 'Funciona en todas partes', fr: 'Fonctionne partout' },
    whyEverywhereB: { en: 'Access tools from any device, anytime, anywhere.', ko: '언제 어디서나 모든 기기에서 도구를 사용하세요.', de: 'Nutze die Tools auf jedem Gerät, jederzeit und überall.', es: 'Accede a las herramientas desde cualquier dispositivo, cuando y donde quieras.', fr: 'Accédez aux outils depuis n’importe quel appareil, à tout moment.' },
    aiPreviewLead: { en: 'Go beyond conversion.', ko: '변환, 그 이상으로.', de: 'Mehr als nur Konvertierung.', es: 'Ve más allá de la conversión.', fr: 'Allez au-delà de la conversion.' },
    aiPreviewHeadline: { en: 'Turn documents, audio, and images into usable content.', ko: '문서, 오디오, 이미지를 바로 쓸 수 있는 콘텐츠로 바꾸세요.', de: 'Verwandle Dokumente, Audio und Bilder in nutzbare Inhalte.', es: 'Convierte documentos, audio e imágenes en contenido útil.', fr: 'Transformez documents, audio et images en contenu exploitable.' },
    aiPreviewCta: { en: 'Try AI Tools', ko: 'AI 도구 사용하기', de: 'KI-Tools testen', es: 'Probar herramientas AI', fr: 'Essayer les outils IA' },
    aiCardTranscribeB: { en: 'Transcribe audio and video to text.', ko: '오디오와 비디오를 텍스트로 전사합니다.', de: 'Transkribiere Audio und Video zu Text.', es: 'Transcribe audio y video a texto.', fr: 'Transcrivez l’audio et la vidéo en texte.' },
    aiCardBgB: { en: 'Remove backgrounds from any image.', ko: '어떤 이미지든 배경을 제거합니다.', de: 'Entferne Hintergründe aus jedem Bild.', es: 'Elimina el fondo de cualquier imagen.', fr: 'Supprimez l’arrière-plan de n’importe quelle image.' },
    aiCardSummaryB: { en: 'Summarize readable PDFs into a simple outline.', ko: '읽을 수 있는 PDF를 간단한 개요로 요약합니다.', de: 'Fasse lesbare PDFs zu einer einfachen Übersicht zusammen.', es: 'Resume PDFs legibles en un esquema sencillo.', fr: 'Résumez les PDF lisibles en un plan simple.' },
    aiCardOcrB: { en: 'Extract text from images and PDFs with AI.', ko: 'AI로 이미지와 PDF에서 텍스트를 추출합니다.', de: 'Extrahiere Text aus Bildern und PDFs mit KI.', es: 'Extrae texto de imágenes y PDFs con IA.', fr: 'Extrayez le texte des images et PDF grâce à l’IA.' },
    useCasesTitle: { en: 'Built for everyone', ko: '모두를 위한 도구', de: 'Für alle gemacht', es: 'Hecho para todos', fr: 'Conçu pour tous' },
    useOffice: { en: 'For Office Workers', ko: '사무직을 위해', de: 'Für Büroangestellte', es: 'Para oficinistas', fr: 'Pour les bureaux' },
    useCreators: { en: 'For Creators', ko: '크리에이터를 위해', de: 'Für Kreative', es: 'Para creadores', fr: 'Pour les créateurs' },
    useStudents: { en: 'For Students', ko: '학생을 위해', de: 'Für Studierende', es: 'Para estudiantes', fr: 'Pour les étudiants' },
    useDevelopers: { en: 'For Developers', ko: '개발자를 위해', de: 'Für Entwickler', es: 'Para desarrolladores', fr: 'Pour les développeurs' },
    useSellers: { en: 'For Online Sellers', ko: '온라인 셀러를 위해', de: 'Für Online-Händler', es: 'Para vendedores online', fr: 'Pour les vendeurs en ligne' },
    guideSectionLead: {
    ...
    dashTitle: { en: 'Dashboard', ko: '내 계정', de: 'Dashboard', es: 'Panel', fr: 'Tableau de bord' },
    dashGreetA: { en: 'Welcome back', ko: '환영합니다', de: 'Willkommen zurück', es: 'Bienvenido de nuevo', fr: 'Bon retour' },
    dashGreetB: { en: ' — your membership, credits, and activity at a glance.', ko: '님 — 멤버십, 크레딧, 활동 내역을 한눈에 확인하세요.', de: ' — Mitgliedschaft, Credits und Aktivität auf einen Blick.', es: ' — tu membresía, créditos y actividad de un vistazo.', fr: ' — votre abonnement, vos crédits et votre activité en un coup d’œil.' },
    statHistory: { en: 'Saved conversions', ko: '저장된 변환', de: 'Gespeicherte Konvertierungen', es: 'Conversiones guardadas', fr: 'Conversions enregistrées' },
    recentConversions: { en: 'Recent conversions', ko: '최근 변환 기록', de: 'Letzte Konvertierungen', es: 'Conversiones recientes', fr: 'Conversions récentes' },
    viewAll: { en: 'View all', ko: '전체 보기', de: 'Alle ansehen', es: 'Ver todo', fr: 'Tout voir' },
